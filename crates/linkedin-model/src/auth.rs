//! All objects related to the auth flows defined by LinkedIn API
...
pub struct Token {
    ...
    /// [`linkedin-macros`]() to build it at
    /// compile time easily.
    // The token response from linkedin is singular, hence the rename to `scope`
